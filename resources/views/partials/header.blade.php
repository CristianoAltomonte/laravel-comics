<div class="top-header">
    ...
    <div class="container d-flex align-items-center justify-content-end">
        ...
        <span class="font-size text-white mx-2">DC POWER VISA@</span>
        <span class="font-size text-white mx-2">ADDITIONAL DC SITES</span>

    </div>

</div>

<nav class="container d-flex w-75">
    <ul class="d-flex align-items-center m-0 p-3">
        ...
        <li class="mx-3 list-unstyled fw-bold active"> <a href="{{ route ('index.comic')}}">COMICS</a> </li>
